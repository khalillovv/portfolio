		...
		<table className={cn('table-auto w-full mt-12', className)}>
			<thead className='sticky top-0 z-10 backdrop-blur-md bg-backgroundPrimary/80'>
				<tr className='text-left text-title'>
					...
					<th className='w-20p pr-8 py-4 font-semibold text-xs'>Project</th>
					<th className='w-2/6 pr-8 py-4 font-semibold text-xs'>Built with</th>
					<th className='w-2/6 py-4 font-semibold text-xs'>Link</th>
				</tr>
			</thead>
			<tbody>
